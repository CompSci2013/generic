...
## Milestone Overview (28 Milestones)

### **Framework Milestones (F1-F20)**: Build the reusable framework
- 20 milestones to build domain-agnostic infrastructure
...
### **Application Instance Milestones (A1-A4)**: Deploy the instance
- 4 milestones to wire framework + domain config
- Result: Production-ready automobile discovery application

---

## FRAMEWORK MILESTONES (F1-F20)
...
- **Generic test utilities** (no domain assumptions)
- Mock factories for testing framework components
- CI/CD integration

**Success Criteria**: Framework components can be tested with mock data

---

### **Tier 2: Reusable Component Framework (Weeks 5-6)**

#### **F7: Generic Base Table Component**
...
#### **F8: Generic Picker Component System**
**Type**: Framework - Component
**Dependencies**: F1
...
#### **F9: Generic Chart Component Framework**
**Type**: Framework - Component
**Dependencies**: F1
...
#### **F10: Generic Error Handling System**
...
#### **F11: Generic State Persistence Service**
**Type**: Framework - Service
**Dependencies**: F1
...
#### **F14: Generic Pop-Out Window System**
**Type**: Framework - Feature
**Dependencies**: F3
...
#### **F16: Generic Hierarchical/Cascading Picker**
**Type**: Framework - Component
**Dependencies**: F8
...
- Column state persistence (via F11)
...
## APPLICATION INSTANCE MILESTONES (A1-A4)
...
#### **A3: Testing & Validation**
**Type**: Application Instance
**Dependencies**: A1, A2, F6

**Deliverables**:
- E2E tests for automobile domain
...
Before F20 is complete, audit `framework/` directory:
...
| 2-4 | 1 | F2-F6 | Core framework infrastructure |
| 5-6 | 2 | F7-F11 | Reusable components |
| 7-8 | 3 | F12-F20 | Advanced features + config schema |
| 9 | 4 | D1-D4 | Automobile domain configuration |
| 10 | 5 | A1-A4 | Application instance deployed |

...
**To fix:** `npx get-stuff-done-cc --global`
...
- URL: `https://raw.githubusercontent.com/glittercowboy/get-stuff-done/main/CHANGELOG.md`
...
```bash
cat ~/.claude/get-stuff-done/CHANGELOG.md 2>/dev/null
```
...
**To update:** `npx get-stuff-done-cc --global`
```
